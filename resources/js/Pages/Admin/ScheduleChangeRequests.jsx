                                ...
                                <div className="flex flex-wrap gap-3">
                                    {req.attachments_data.map((attachment, idx) => (
                                        <div
                                            ...
                                            onClick={(e) => { 
                                                e.stopPropagation(); 
                                                setPreviewState({ attachments: req.attachments_data, startIndex: idx }); 
                                                setShowPreviewModal(true); 
                                            }}
                                            className="group relative cursor-pointer overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 transition hover:border-blue-400 dark:hover:border-blue-500 w-32 h-32 flex items-center justify-center"
                                        >
                                            {attachment.url.match(/\.(jpeg|jpg|gif|png|webp)$/i) ? (
                                                <img src={attachment.url} alt={attachment.custom_label} className="w-full h-full object-cover opacity-90 group-hover:opacity-100 transition-opacity" />
                                            ) : (
                                                <div className="flex flex-col items-center justify-center text-gray-400 dark:text-gray-500 group-hover:text-blue-500 transition-colors">
                                                    ...
                                                    <span className="text-[10px] font-semibold truncate w-full px-2 text-center">{attachment.custom_label || 'View Document'}</span>
                                                </div>
                                            )}
