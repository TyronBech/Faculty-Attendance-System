...
export default function ManualAttendanceRequests({
    ...
    const [selectedDate, setSelectedDate] = useState(
        availableDates && availableDates.length > 0 ? availableDates[0] : null,
    );
    ...
    const [currentPage, setCurrentPage] = useState(
        initialRequests.current_page || 1,
    );
    const [countingRequestsCount, setCountingRequestsCount] = useState(
        approvedCountingRequestsCount,
    );
    ...
    const handleCreate = (e) => {
        ...
        formData.append(
            ...
            createForm.data.attendance_record_id,
        );
        ...
        router.post(
            route("faculty.manual-attendance-requests.store"),
            formData,
            {
                preserveScroll: true,
                ...
                onError: (errors) => {
                    ...
                    toast.error(
                        firstError || "Please fix the errors and try again.",
                    );
                },
            },
        );
    ...
    const handleCancel = () => {
        cancelForm.delete(
            route(
                "faculty.manual-attendance-requests.destroy",
                selectedRequest.id,
            ),
            {
                preserveScroll: true,
    ...
    const fetchRequests = useCallback((status, page = 1) => {
        ...
        fetch(
            route("faculty.manual-attendance-requests.filter") +
                "?" +
                params.toString(),
            {
            ...
            .then((data) => {
                ...
                setCountingRequestsCount(
                    data.approvedCountingRequestsCount || 0,
                );
                    ...
                    <div className="flex items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-xs text-blue-700 dark:text-blue-400 mt-1">
                                You have {countingRequestsCount} of{" "}
                                {requestLimit} approved requests that count
                                towards your annual limit.
                            </p>
                        </div>
                                        ...
                                        <div className="flex items-start justify-between gap-4">
                                            <div className="flex-1">
                                                <div className="flex items-center gap-3 flex-wrap">
                                                    ...
                                                    <span
                                                        className={`inline-flex items-center rounded-md px-2.5 py-1 text-xs font-bold ring-1 ring-inset ${STATUS_STYLES[request.status]}`}
                                                    >
                                                        {request.status
                                                            .charAt(0)
                                                            .toUpperCase() +
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    {request.status ===
                                                        ...
                                                        <div className="rounded-xl bg-yellow-50 dark:bg-yellow-900/20 p-4 border border-yellow-100 dark:border-yellow-800/50">
                                                            <p className="text-xs font-bold text-yellow-600 dark:text-yellow-400 uppercase tracking-wider mb-2">
                                                                Pending Review
                                                            </p>
                    ...
                    <div className="space-y-6 p-6">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                Submit a request to record your manual time
                                in/out entries
                            </p>
                        </div>
                            ...
                            <div className="flex justify-center">
                                <div className="rounded-lg bg-yellow-50 p-4 border border-yellow-200 dark:bg-yellow-900/20 dark:border-yellow-800 text-center max-w-sm">
                                    <p className="text-sm text-yellow-800 dark:text-yellow-200">
                                        No dates available for manual time
                                        entry. All your attendance records have
                            ...
                            <form onSubmit={handleCreate} className="space-y-6">
                                ...
                                <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                                    ...
                                    <div>
                                        ...
                                        <InputError
                                            message={
                                                createForm.errors.justification
                                            }
                                        />
            ...
            >
                <div className="space-y-6 p-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                        Are you sure you want to delete this manual attendance
